...
type TeamEventStatus struct {
	Qual *AnyOfTeamEventStatusQual `json:"qual,omitempty"`
	Alliance *AnyOfTeamEventStatusAlliance `json:"alliance,omitempty"`
	Playoff *AnyOfTeamEventStatusPlayoff `json:"playoff,omitempty"`
