...
The project uses a **repository pattern** to decouple HTTP handlers from direct database access. All database interactions go through domain-specific `Store` interfaces, with mocks auto-generated by [mockery](https://github.com/vektra/mockery). This lets you write fast, hermetic unit tests without a running PostgreSQL instance.
